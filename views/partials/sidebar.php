<div class="sidebar d-flex flex-column py-3">
  <div class="brand">⚡ QLynk</div>
  <hr class="border-secondary mx-3">
  <a href="/dashboard"><i class="bi bi-speedometer2 me-2"></i>Dashboard</a>
  <a href="/qrs"><i class="bi bi-qr-code me-2"></i>QR Dinámicos</a>
  <a href="/qrs/static" style="padding-left:32px;font-size:13px">
    <i class="bi bi-qr-code-scan me-2"></i>QR Estáticos
  </a>
  ...
  <a href="/logout"><i class="bi bi-box-arrow-left me-2"></i>Salir</a>
</div>
